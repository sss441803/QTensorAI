...
from .base import relabel_graph_nodes, get_simple_graph
from .base import make_clique_on
from .peo_calculation import (
    get_peo, get_treewidth_from_peo)
from .importers import circ2graph
...
def is_clique(old_graph, vertices):
    ...
    have_edges = set(subgraph.edges()) - set(nx.selfloop_edges(subgraph))
